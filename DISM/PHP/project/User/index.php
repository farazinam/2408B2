                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-item">
                                <div class="position-relative bg-light overflow-hidden">
                                    <img class=" w-100" src="../Admin/image/<?php echo $fetch["product_image"] ?> " alt="" height="200px">
                                ...
                                <div class="text-center p-4">
                                    ...
                                    <span class="text-body text-decoration-line-through">$29.00</span> <br>
                                    <span class="text-primary me-1"> <?php echo $fetch["product_description"] ?> </span>
                                </div>
                                <div class="d-flex border-top">
                                    <small class="w-50 text-center border-end py-2">
                                        <a class="text-body" href="detailPage.php?id=<?php echo $fetch["product_id"] ?>"><i class="fa fa-eye text-primary me-2"></i>View detail</a>
                                    </small>
